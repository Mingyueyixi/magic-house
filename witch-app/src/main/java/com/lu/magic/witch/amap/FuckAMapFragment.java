package com.lu.magic.witch.amap;
...
import com.lu.magic.witch.util.AMapUtil;
...
//        json.put("adress", mLocationClient.getLastKnownLocation().getAddress());
            intent.putExtra(BridgeConstant.CODE_INTENT_RESULT_DATA, json.toString());
